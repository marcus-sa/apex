...
const button = cva(['text-white', 'text-xs', 'rounded-sm', 'px-4', 'py-1.5', 'min-w-20', 'flex', 'justify-center', 'content-center', 'tracking-wide'], {
  variants: {
    intent: {
      primary: ['hover:bg-[#393839]', 'hover:bg-[#4c4a4b]', 'bg-[#282729]', 'border-t', 'shadow-sm', 'border-[#3d3c3d]', 'hover:border-[#4b4a4b]']
    },
  },
});
